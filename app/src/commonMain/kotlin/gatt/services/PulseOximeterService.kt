...
import data.*
import data.pulseoximeter.PulseOximeterDeviceAndSensorStatusSupport
import data.pulseoximeter.PulseOximeterMeasurementStatusSupport
import data.pulseoximeter.PulseOximeterSupportedFeatures
import gatt.parse
            ...
            requirement {
                ...
                format = {
                    PulseOximeterDeviceAndSensorStatusSupport(
                        ...
                        signalProcessingIrregularityDetected = deviceAndSensorStatusSupport.positiveBitAt(
                            2
                        ),
